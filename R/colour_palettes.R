...
#' HEX Codes of the EastBIO Colours
#'
#' Access the HEX codes of the colours used in the EastBIO logo.
#'
#' @return The HEX codes of the EastBIO colours.
#' @family Palettes
#' @export
#'
#' @examples
...
#' Palette Generating Function For EastBIO Colours
#'
#' @param colours The colours to interpolate between. By default these are set
#'     to the colours from the EastBIO logo.
#' @param bias A positive number. Higher values will give more widely spaced
#'     colours at the higher end of the colour spectrum.
#' @param space A character string indicating whether the colours should be
#'     interpolated in RGB or CIE Lab colour spaces.
...
#' @family Helper Functions
#'
ebio_colours_palette_func_gen <- function(
...
#' Interpolated HEX Codes of the EastBIO Colours
#'
#' Access HEX codes of colours that have been interpolated between those used in
#' the EastBIO logo.
#'
...
#' @param ... Arguments to be passed to `grDevices::colorRampPalette`.
#'
#' @return A character vector of colours interpolated from the colours in the CGEM
#'     logo.
#' @family Palettes
#' @export
#'
...
ebio_colours_n <- function(
  ...
  func_gen <- ebio_colours_palette_func_gen(
    colors = colours,
    bias = bias,
    space = space,
    interpolate = interpolate,
