...
#'   guides(colour = "none") +
#'   coord_equal() +
#'   scale_colour_ukri_d(colours = "purple")
#'
...
#' CRUK Logo Colour Scales (Discrete)
#'
#' A layer that can be added to `ggplot2` plots to change the colour aesthetic
...
#' CGEM Logo Colour Scales (Discrete)
#'
#' A layer that can be added to `ggplot2` plots to change the colour aesthetic
...
#' EastBIO Logo Colour Scales (Discrete)
#'
#' A layer that can be added to `ggplot2` plots to change the colour aesthetic
...
#'   scale_colour_ebio_d()
#'
scale_colour_ebio_d <- function(
    aesthetics = "colour",
    scale_name = "EBIO_Colours",
    palette = ebio_colours_palette_func_gen(),
    name = ggplot2::waiver(),
    breaks = ggplot2::waiver(),
    labels = ggplot2::waiver(),
    limits = NULL,
